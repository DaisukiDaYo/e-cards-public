...
Vue.component('background-1', {
    ...
    methods: {
      calculateViewPort: function () {
        ...
        console.log("TCL: this.width", this.width)
        this.height = window.innerHeight * 6;
        console.log("TCL: this.height", this.height)
      }
    },
    created() {
    ...
    template: `
    <g id="bg-wallpaper">
        <rect id="Rectangle_1" data-name="Rectangle 1" class="cls-2 svg-background" :width="width * 3" :height="height * 2"/>
